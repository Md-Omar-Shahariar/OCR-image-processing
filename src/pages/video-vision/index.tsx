                ...
                {frames.length > 0 && (
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                      {frames.map((frame) => {
                        const previewText =
                          frame.text?.trim() || "No detected text on this frame.";
                        const wordCount = previewText.split(/\s+/).filter(Boolean).length;

                        return (
                          <div
                            key={frame.index}
                            className="group relative overflow-hidden rounded-3xl border border-emerald-100/70 bg-white/90 backdrop-blur shadow-lg transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl"
                          >
                            ...
                            <div className="relative mx-4 mt-3 overflow-hidden rounded-2xl border border-white/60 bg-slate-100 aspect-video">
                              ...
                              <div className="absolute inset-x-3 bottom-3 rounded-2xl bg-slate-900/75 p-3 text-slate-50 shadow-lg backdrop-blur">
                            ...
                            <div className="flex items-center justify-between px-4 py-3 text-sm text-slate-600">
                              <div className="inline-flex items-center gap-2 text-emerald-700">
                                ...
                                >
                                  <path
                                    ...
                                    strokeLinejoin="round"
                                    strokeWidth={2}
                                    d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14m-6 0l-4.553 2.276A1 1 0 013 15.382V8.618a1 1 0 011.447-.894L9 10m6 0L9 14m6-4V7m0 3v4m-6-3V7m0 3v4"
                                  />
                                </svg>
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-emerald-500 to-sky-500 px-4 py-2 text-white font-semibold shadow-md transition hover:shadow-lg hover:from-emerald-600 hover:to-sky-600"
                              >
                                <svg
                                  className="h-4 w-4"
                                  fill="none"
